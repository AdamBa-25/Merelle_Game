...
/**
 * Tests de MerelleController.parseCoord().
 *
 * parseCoord() est statique et ne dépend d'aucun état du contrôleur,
 * ce qui permet de la tester sans mock ni framework boardifier.
 *
 * Convention du plateau (row = lettre A-G, col = chiffre 1-7) :
 *   La lettre indique la LIGNE (A=ligne 0 ... G=ligne 6).
 *   Le chiffre indique la COLONNE (1=col 0 ... 7=col 6).
 *
 * Correspondances réelles (d'après POS_TO_GRID) :
 *   A1= 0  A4= 1  A7= 2
 *   B2= 3  B4= 4  B6= 5
 *   C3= 6  C4= 7  C5= 8
 *   D1= 9  D2=10  D3=11
...
class MerelleControllerParseCoordTest {
    ...
    // =========================================================================
    // Cas valides — toutes les 24 positions
    // =========================================================================
    ...
    // =========================================================================
    // Cas invalides — lettres hors A-G
    // =========================================================================
    ...
    // =========================================================================
    // Cas invalides — chiffres hors 1-7
    // =========================================================================
    ...
    // =========================================================================
    // Cas invalides — cases de la grille 7x7 qui ne sont pas des positions valides
    // =========================================================================
    ...
    // =========================================================================
    // Cas invalides — saisies malformées
    // =========================================================================
    ...
    class MalformedInput {
        ...
        void withSpaces_trimmed() {
            // parseCoord() appelle trim() → "A1" avec espaces autour doit fonctionner
