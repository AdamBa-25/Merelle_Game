...
/**
 * Tests de MerellePawn.
 *
 * GameStageModel est mocké car MerellePawn l'exige dans son constructeur
 * mais ne l'utilise pas directement — seul ElementTypes.register() est appelé.
 */
...
class MerellePawnTest {
    ...
    void getColorName_invalid_returnsInconnu() {
        assertEquals("Inconnu", MerellePawn.getColorName(-1));
        assertEquals("Inconnu", MerellePawn.getColorName(99));
    }

    // =========================================================================
    // isValidColor() — statique
    // =========================================================================
    ...
    // =========================================================================
    // getBackgroundColor() — chaîne ANSI non nulle et non vide
    // =========================================================================
    ...
    // =========================================================================
    // getTextColor() — cohérence avec les fonds sombres/clairs
    // =========================================================================
    ...
    // =========================================================================
    // printColorMenu() — ne doit pas lever d'exception
    // =========================================================================
