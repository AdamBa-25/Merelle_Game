...
/**
 * Tests de MerelleStageModel.
 *
 * Model est mocké car MerelleStageModel l'exige dans son constructeur
 * mais seules les méthodes de logique pure (phase, pions en main,
 * historique, moulins) sont testées ici.
 */
...
class MerelleStageModelTest {
    ...
    // =========================================================================
    // getColorJ1 / getColorJ2 — gardes null
    // =========================================================================
    ...
    class ColorGuards {
        ...
        void getColorJ1_nullPawns_returnsDefault() {
            // pawnsJ1 est null par défaut dans le constructeur
    ...
    class DecreasePawns {
        ...
        void decreasePawnsInHand_player0() {
            ...
            assertEquals(9, stageModel.getPawnsInHand(1)); // J1 inchangé
        }
        ...
        void decreasePawnsInHand_player1() {
            ...
            assertEquals(9, stageModel.getPawnsInHand(0)); // J0 inchangé
    ...
    class DrawByRepetition {
        ...
        void draw_falseWhenOnlyJ0Repeats() {
            ...
            stageModel.recordMove(1, "3->4");
            stageModel.recordMove(0, "9->10");
            stageModel.recordMove(1, "5->13"); // J1 change
            assertFalse(stageModel.isDrawByRepetition());
        }
        ...
        void draw_falseWhenOnlyJ1Repeats() {
            stageModel.recordMove(0, "9->10");
            stageModel.recordMove(1, "3->4");
            stageModel.recordMove(0, "10->11"); // J0 change
            stageModel.recordMove(1, "3->4");
            assertFalse(stageModel.isDrawByRepetition());
        }
        ...
        void draw_playerIdPrefixPreventsConfusion() {
            // Si les deux joueurs jouent exactement la même string sans préfixe,
            // l'ancien bug déclencherait un faux draw. Le préfixe l'empêche.
            stageModel.recordMove(0, "same_move");
            stageModel.recordMove(1, "same_move");
            stageModel.recordMove(0, "same_move");
            stageModel.recordMove(1, "same_move");
            // Avec préfixe : "0:same_move" != "1:same_move" → [1] != [3] → draw = false
            // SAUF si par hasard "0:same_move" == "0:same_move" ET "1:same_move" == "1:same_move"
            // ce qui EST vrai ici → c'est un vrai draw (les deux joueurs font le même coup)
            assertTrue(stageModel.isDrawByRepetition()); // draw légitime dans ce cas
        }
    ...
    // =========================================================================
    // recordLastMill() / isSameMillAsLast() / clearLastMill()
    // =========================================================================
    ...
    class MillMemory {
        ...
        void isSameMillAsLast_orderIndependent() {
            stageModel.recordLastMill(0, new int[]{2, 0, 1}); // ordre quelconque
            assertTrue(stageModel.isSameMillAsLast(0, new int[]{0, 1, 2}));
        ...
        void clearLastMill_doesNotClearMemory() {
            ...
            // La mémoire persiste — clearLastMill() est intentionnellement vide
            assertTrue(stageModel.isSameMillAsLast(0, new int[]{0, 1, 2}));
        }
        ...
        void recordLastMill_overwritesPrevious() {
            stageModel.recordLastMill(0, new int[]{0, 1, 2});
            stageModel.recordLastMill(0, new int[]{9, 10, 11}); // nouveau moulin
            assertFalse(stageModel.isSameMillAsLast(0, new int[]{0, 1, 2}));
